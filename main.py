...
def contact():
    mess._show(title='Contact us',
               message="Please contact us on : 'saniapimple@gmail.com' ")
...
def TakeImages():
    ...
    columns = ['SERIAL NO.', '', 'ID', '', 'NAME', '', 'TIME', '', 'DAY']
...
window.title("Attendance System Project By Sania Pimple ACE SE-CMPN Grp.14")
window.configure(background="#00BFFF")

frame1 = tk.Frame(window, bg="#FFDAB9")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#FFDAB9")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Face Recognition Based Attendance System",
                    fg="white", bg="#0000FF", width=55, height=1, font=('times', 29, ' bold '))
...
datef = tk.Label(frame4, text=day+"-"+mont[month]+"-"+year+"  |  ", fg="orange",
                 bg="#0000FF", width=55, height=1, font=('times', 22, ' bold '))
datef.pack(fill='both', expand=1)

clock = tk.Label(frame3, fg="orange", bg="#0000FF", width=55,
                 height=1, font=('times', 22, ' bold '))
clock.pack(fill='both', expand=1)
tick()

head2 = tk.Label(frame2, text="                       For New Registrations                       ",
                 fg="white", bg="#800000", font=('times', 17, ' bold '))
...
lbl = tk.Label(frame2, text="Enter ID", width=20, height=1,
               fg="white", bg="#4B0082", font=('times', 17, ' bold '))
lbl.place(x=80, y=55)

txt = tk.Entry(frame2, width=32, fg="black", font=('times', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name", width=20, fg="white",
                bg="#4B0082", font=('times', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2, width=32, fg="black", font=('times', 15, ' bold '))
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile", bg="#00FF00",
                    fg="black", width=39, height=1, activebackground="yellow", font=('times', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="", bg="#FF4500", fg="black", width=39,
                   height=1, activebackground="yellow", font=('times', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Made by Sania Pimple", width=18, fg="black",
                bg="#FF4500", height=1, font=('times', 15, ' bold '))
...
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy, fg="black", bg="#FF0000",
